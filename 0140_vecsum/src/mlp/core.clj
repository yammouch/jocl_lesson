...
(defn -main [& _]
  (cl/let-err err
    [conf [{:gws [ 512 512 16] :lws [ 64  1 1]}
           ...
           {:gws [2048 512 16] :lws [256  1 1]}
           {:gws [1024 512 32] :lws [256  1 1]}
           {:gws [ 512 512 64] :lws [128  2 1]}
           {:gws [ 512 512 64] :lws [ 64  4 1]}
           {:gws [ 512 512 64] :lws [ 32  8 1]}
           {:gws [ 512 512 64] :lws [ 16 16 1]}
           {:gws [ 512 512 64] :lws [  8 32 1]}
           {:gws [ 512 512 64] :lws [  4 64 1]}
           {:gws [ 512 512 64] :lws [128  1 2]}
           {:gws [ 512 512 64] :lws [ 64  1 4]}
           {:gws [ 512 512 64] :lws [512  1 1]}
           {:gws [ 512 512 64] :lws [256  2 1]}
           {:gws [ 512 512 64] :lws [128  4 1]}
           {:gws [ 512 512 64] :lws [512  2 1]}]
