...
(defn test-pattern [size]
  (as-> (concat (for [g0 [2    ] g1 [2 3 4] g2 [2 3 4]
                      g3 [2    ] g4 [2    ] g5 [2    ]]
                  (position-variation (mlp.meander/meander-0 size
                                       [(+ g0 g2) g1 g2 g3 g4 g5])
                ...
                (for [g0 [4    ] g1 [4    ] g2 [2 3 4]
                      g3 [2 3 4] g4 [2    ] g5 [2    ]]
                  (position-variation (mlp.meander/ring-0 size
                                       [g0 g1 g2 g3 g4 g5])
                                      (utl/xorshift 3 6 9 12)))
                (for [g0 [4    ] g1 [-4   ] g2 [-2 -3 -4]
                      g3 [2 3 4] g4 [2    ] g5 [2       ]]
                  (position-variation (mlp.meander/ring-0 size
                                       [g0 g1 g2 g3 g4 g5])
                                      (utl/xorshift 3 6 9 12)))) s
        (apply map vector s)))
